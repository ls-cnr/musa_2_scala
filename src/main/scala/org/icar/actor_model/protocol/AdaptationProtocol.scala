...
package object AdaptationProtocol extends Protocol {
	...
	def concrete_failure(concrete_id:String) : ProtocolPart = InformConcreteFailure(get_id,concrete_id)
	...
	case class InformConcreteFailure private(id:Long,concrete_id:String) extends ProtocolPart
